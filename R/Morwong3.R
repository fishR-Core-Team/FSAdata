#'Age of Morwong assigned by two readers.
#'
#'Ages assigned by two different readers to the otoliths of Jackass Morwong
#'(\emph{Nemadactylus macropterus}).
#'
#'@name Morwong3
#'@docType data
#'@format A data frame with 58 paired observations on the following 2
#'variables.  \describe{
...
#' \item Ageing error 
#'}
#'@source Extracted from table 7 of Restall, J.E., and K. Krusic-Golub.  2004.
