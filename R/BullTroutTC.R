...
#'
#'Catch-at-age (actually carcasses-at-age) for Bull Trout (\emph{Salvelinus
#'confluentis}) in Trestle Creek, ID.
#'
#'@name BullTroutTC
#'@docType data
...
#'North American Journal of Fisheries Management 26:190-200.
#'@keywords datasets
#'@examples
#'data(BullTroutTC)
#'str(BullTroutTC)
