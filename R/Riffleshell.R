...
#'
#'The number of mussels caught in multiple samples of Tan Riffleshell
#'(\emph{Epioblasma florentina walkeri}) from Indian Creek, Virginia.  The
#'caught fish were examined for previous marks, marked (if previously
#'unmarked), and then returned to the population.
#'
#'@name Riffleshell
#'@docType data
