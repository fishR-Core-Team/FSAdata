...
#'consecutive days in 1986.
#'
#'Catch (numbers) of lobster in three categories - legal (tail weight greater
#'than 85g), sublegal (tail weight less than 85g), and berried (egg-bearing
#'females).  Sublegal and berried lobsters were returned to the water.
#'
#'The vessel fished between 11 June and 14 July 1986 in the vicinity of Laysan
#'Island and its associated bank.  The daily operations of the vessel involved
#'deploying and hauling 1,125 Fathom Plus lobster traps set in strings spaced
#'at 30 m intervals.  They were fished in 7 strings of about 160 traps each and
#'baited with Pacific Mackerel, \emph{Scomber japonicus}. Strings were soaked
#'overnight and retrieved the following day; therefore, the standard unit of
#'effort is the trap-haul.
#'
#'@name LobsterHI
#'@docType data
...
#'Marine Fisheries Review, 52(2):1-7.
#'@keywords datasets
#'@examples
#'data(LobsterHI)
#'str(LobsterHI)
