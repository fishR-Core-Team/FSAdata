#'Lengths of Troutperch in Lake Michigan, 1977.
#'
#'Troutperch (\emph{Percopsis omiscomaycus}) fork lengths from near Grand
#'Haven, Lake Michigan, 1977.
#'
#'@name TroutperchLM2
#'@docType data
...
#'Journal of Fisheries and Aquatic Sciences.  37:1557-1564.
#'@keywords datasets
#'@examples
#'data(TroutperchLM2)
#'str(TroutperchLM2)
