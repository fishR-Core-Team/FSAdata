#'Catch in removal events of salmon parr.
#'
#'Catch in removal events of salmon parr from the Afon Dulas at Pentre, 19Jun79.
#'
#'@name SalmonADP
#'@docType data
...
#'@source From Table 2 in Cowx, I.G.  1983.  Review of the methods for estimating 
