...
#'
#'White Shrimp (\emph{Litopenaeus setiferus}) stock and recruitment data for
#'White Shrimp off the coast of Georgia (USA), 1979-2000.
#'
#'No graph was shown for stock values vs. year so some stock values had to be
#'haphazardly paired with recruit values -- especially for stock values between
#'2.5 and 3.0.
#'
#'@name WShrimpGA
#'@docType data
...
#' \item{yrconf}{A code of confidence for whether or not the stock value is known
#'  to come from the year shown.  See details} 
#'}
