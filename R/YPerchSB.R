...
#'
#'Yellow Perch (\emph{Perca flavescens}) stock and recruitment by year in South
#'Bay, Lake Huron, 1950-1983.
#'
#'@name YPerchSB
#'@docType data
...
#'recruitment of yellow perch, \emph{Perca flavescens} Mitchill, in South Bay,
#'Lake Huron. Journal of Fisheries Biology 26:449-458.
#'@keywords datasets
#'@examples
#'data(YPerchSB)
#'str(YPerchSB)
