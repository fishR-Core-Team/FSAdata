...
#'
#'Landings and value of Lake Whitefish \emph{Coregonus clupeaformis} in Lake
#' Superior by state from 1971-2001.
#'
#'@name WhitefishLS
#'@docType data
...
#'}
#'@source Results from a query in 2006 at \url{www.st.nmfs.gov/pls/webpls/webst1.MF_GL_SPECIES_HELP.SPECIES}.
#'@keywords datasets
#'@examples
#'data(WhitefishLS)
#'str(WhitefishLS)
