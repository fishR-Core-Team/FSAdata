...
#'
#'Vendace (\emph{Coregonus albula}) recruitment by year in Lake Puulavesi, 1982-1996.
#'
#'@name VendaceLP
#'@docType data
...
#'additional variables, biases and errors.  Ecology of Freshwater Fish 13:46-60.
#'@keywords datasets
#'@examples
#'data(VendaceLP)
#'str(VendaceLP)
