#'Lengths of Largemouth Bass from Lake Carl Blackwell.
#'
#'Length measurements of Largemouth Bass (\emph{Micropterus salmoides}) from
#'Lake Carl Blackwell, Oklahoma, in 1973.
#'
#'@name LMBassLCB
#'@docType data
...
#'maximum-likelihood estimator for analysis of length-frequency distributions.
