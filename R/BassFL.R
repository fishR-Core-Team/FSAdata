...
#' 
#' @source From Figure 2 of Bonvechio, T.F., M.S. Allen, and R.L. Cailteux.  2005.  \href{http://sfrc.ufl.edu/allenlab/publications/2005bonvechio_allen_cailteux.pdf}{Relative Abundance, Growth, and Mortality of Suwannee Bass in Four Florida Rivers}.  North American Journal of Fisheries Management 25:275-283.
#' 
#' @keywords datasets
#' 
#' @examples
