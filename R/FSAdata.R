...
#'\code{help.search("Capture history",package=c("FSAdata","FSA"))} \tab Capture history mark-recapture
#'(compare to summarized data) data.\cr
#'\code{help.search("Schnabel",package=c("FSAdata","FSA"))} \tab Schnabel mark-recapture (closed 
...
#'\code{help.search("Removal",package=c("FSAdata","FSA"))} \tab Removal (K-pass) methods for 
