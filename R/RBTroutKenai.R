...
#'
#'Length-at-marking and recapture and time-at-large for Rainbow Trout
#'(\emph{Oncorhynchus mykiss}) in the Kenai River, Alaska.
#'
#'@name RBTroutKenai
#'@docType data
...
#'Quinn II.  1991.  A general growth model for mark-recapture data.  Fisheries
#'Research 11:257-281.
#'@keywords datasets
#'@examples
#'data(RBTroutKenai)
