...
#'
#'Stock and recruitment data for Northern Pike (\emph{Esoc lucius}) from Lake Windermere.
#'
#'@name PikeWindermere
#'@docType data
...
#'}
#'@note Stock values were originally reported in 1000s of kgs and recruits were
#'originally recorded in tens of numbers.  Thus, plots look very discrete.
