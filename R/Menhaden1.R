...
#'
#'Estimated catch-at-age for Gulf Menhaden (\emph{Brevoortia patronus}), 1964-2004
#' from thereduction fishery in the U.S. Gulf of Mexico.
#'
#'@name Menhaden1
#'@docType data
...
#'  Research 83:263-275.  Available at \url{http://menhaden.gsmfc.org/FishRes_Vaughan_etal_2007-GM.pdf}.
#'@keywords datasets
#'@examples
#'data(Menhaden1)
#'str(Menhaden1)
