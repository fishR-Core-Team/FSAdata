#'Summarized multiple mark-recapture data for Walleye from four lakes in
#'Northern Minnesota.
#'
#'Summary results of capture histories (number captured, number of recaptured
#'fish, and number of unmarked fish that were marked) for Walleye (\emph{Sander
#'vitreus}) collected from four lakes in Northern Minnesota, USA.
#'
#'@name WalleyeMN06b
#'@docType data
...
#'Management, Technical Report 41
#'@keywords datasets
#'@examples
#'data(WalleyeMN06b)
#'str(WalleyeMN06b)
