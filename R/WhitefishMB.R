...
#' \item{lake}{Lake from which the fish was captured (\code{L122}, \code{L226},
#'  \code{Huron}, or \code{Dezadeash}).} 
#'}
...
#'estimates of growth and annual survival.  Canadian Journal of Fisheries and
