...
#'
#'The species targeted, number of fish harvested, and number of individuals harvesting that
#'number of that species of fish from a large number of surveys on Minnesota Lakes, 1980-1996.
#'
#'@name CreelMN
#'@docType data
...
#'}
#'@source From tables in Cook et al. 2001.  Creel limits in Minnesota: A
#'proposal for change.  Fisheries 26:19-26.
#'@keywords datasets
#'@examples
#'data(CreelMN)
#'str(CreelMN)
