...
#'
#'Yellow Perch (\emph{Perca flavescens}) stock-recruitment by year-class in
...
#' \item{stock}{Estimated numbers of mature females caught the year prior to the
#'  origin of the 1975-1986 year classes.} 
