#'Stock and recruitment data for Lake Huron Bloaters.
#'
#'Egg deposition and relative abundance of age-3 Lake Huron Bloaters
#'(\emph{Coregonus hoyi}) by year, 1981-1996.
#'
#'@name BloaterLH
#'@docType data
