...
#'
#'Stock and recruitment data for Exmouth Gulf Tiger Prawn (\emph{Panaeus
#'esculentus}), 1970-1983.
#'
#'@name TPrawnsEG
#'@docType data
...
#'tiger prawn (\emph{Penaeus esculentus}) fishery in Exmouth Gulf, Western
#'Australia.  Australian Journal of Marine and Freslzwater Research 37:491-505.
#'@keywords datasets
#'@examples
#'data(TPrawnsEG)
#'str(TPrawnsEG)
