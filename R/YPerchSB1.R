#'Lengths of Yellow Perch from Saginaw Bay, Lake Michigan.
#'
#'Length measurements of Yellow Perch (\emph{Perca flavescens}) from two
#'locations -- inner and outer bay -- in Saginaw Bay, Lake Michigan.
#'
#'@name YPerchSB1
#'@docType data
...
#'locations in Saginaw Bay, Michigan.  Transactions of the American Fisheries
#'Society 119:976-984.
#'@keywords datasets
#'@examples
#'data(YPerchSB1)
