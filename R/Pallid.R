...
#' \item{w}{Weight (g)}
#' \item{status}{Living status of fish at time of collection (\code{Frozen},
#' \code{Live}, \code{Dead}).} 
#' \item{loc}{Location of fish collection (\code{NB}=Nebraska, \code{SD}=South Dakota,
#' \code{ND}=North Dakota, \code{MT}=Montana)} 
#'}
