...
#'
#'Abundance of age-0 and age-5 and older Walleye (\emph{Sander vitreus}),
#'abundance of adult Yellow Perch (\emph{Perca flavescens}), and coefficient of
#'variation of May temperatures for Escanaba Lake, WI, 1958-1992.
#'
#'@name WalleyeEL
#'@docType data
