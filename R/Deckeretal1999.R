...
#'(\emph{Oncorhynchus clarki}) in consecutive removal events at various locations
#'in Little Stawamus Creek (British Columbia, Canada) in 1997.
#'
#'@name Deckeretal1999
#'@docType data
...
#' \item{habitat}{Habitat type of sampling location -- \code{pool}, \code{riffle},
#' or \code{run}.}
...
#'in a small stream: a comparison of sampling designs.  Canadian Technical Report
#'of Fisheries and Aquatic Sciences 2282.  24 pp.  Available at
#'\href{http://www.dfo-mpo.gc.ca/Library/239481.pdf}{http://www.dfo-mpo.gc.ca/Library/239481.pdf}.
#'@keywords datasets
#'@examples
#'data(Deckeretal1999)
#'str(Deckeretal1999)
